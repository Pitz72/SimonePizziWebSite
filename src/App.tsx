  ...
  const renderPage = () => {
    switch (route) {
      ...
      case Category.NARRATIVA_E_PUBBLICAZIONI:
        return <PortfolioShowcase key={Category.NARRATIVA_E_PUBBLICAZIONI} title="Narrativa e Pubblicazioni" items={portfolioData[Category.NARRATIVA_E_PUBBLICAZIONI]} enabledItemIds={[]} />;
      default:
        return <HomePage />;
    }
  };
