...
/**
 * ┌──────────────────────────────────────────────────────────────────────┐
 * │  IL VECCHIO MOTORE SEO DEL SITO IN REACT — NON È PIÙ IN USO          │
 * └──────────────────────────────────────────────────────────────────────┘
 *
 * Fino al 7 settembre 2026 questo file era public/index.php: serviva l'HTML
 * dell'articolo ai crawler e il guscio dell'applicazione React a tutti gli
 * altri. Il sito nuovo lo ha sostituito, e quel ramo per i crawler è diventato
 * la pagina per tutti (public/pages/).
 *
 * Resta qui, non in uso, per una ragione sola: finché il sito nuovo non è in
 * produzione da un po', il vecchio deve poter tornare su in dieci minuti —
 * basta rinominare questo file in index.php e ricostruire dist/.
 *
 * Si butta insieme a src/, node_modules/ e package.json, quando non servirà
 * più. Nel frattempo non lo carica nessuno: nessuna rotta ci arriva.
 */
