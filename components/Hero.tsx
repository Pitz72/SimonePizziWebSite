  ...
  return (
    <section className="container mx-auto min-h-[calc(80vh)] flex items-center justify-center py-20 md:py-0">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="relative h-64 md:h-96 flex items-center justify-center animate-fade-in [animation-delay:0.2s]">
           <img 
            src="https://picsum.photos/seed/simone-pizzi-hero/800/600" 
            alt="Simone Pizzi"
