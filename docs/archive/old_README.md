...
- [v1.7.6 - Patch: newsletter footer orizzontale + deduplicazione + editor strip SVG](changelogs/1.7.6.md)
- [v1.7.5 - GDPR newsletter, articoli selezionabili in newsletter, RSS header](changelogs/1.7.5.md)
...
### Filone 1.4.x (CMS Golden Master & Redesign Editoriale)
...
- [v1.4.1 - Porting Eredita e Dati Storici SQLite](changelogs/1.4.1.md)
- [v1.4.0 - Golden Master CMS (Blog e Server-Side SEO)](changelogs/1.4.0.md)

### Filone 1.3.x (Mini-CMS: Backend, API e Admin React)
...
### Filone 1.2.x (Premium Design & Data-Driven)
